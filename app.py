...
from models import db, User, Part, Vehicle, Reel, ReelLike, SiteSettings, Message, Notification, IRAQ_CITIES, CAR_BRANDS, FUEL_TYPES, TRANSMISSION_TYPES, VehicleImage, PartImage
...
TRANSLATIONS = {
    'ku': {
        ...
        'login_success': 'بەخێربێیت! چوونەژوورەوەت سەرکەوتوو بوو.',
    ...
    'ar': {
        ...
        'color': 'اللون', 'login_success': 'مرحباً! تم تسجيل الدخول بنجاح.',
    ...
    'en': {
        ...
        'login_success': 'Welcome! You have logged in successfully.',
